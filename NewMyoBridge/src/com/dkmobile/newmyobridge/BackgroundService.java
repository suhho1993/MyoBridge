...
public class BackgroundService extends Service {
	...
	boolean inApp = false;
	appState mAppState = appState.MAIN;
	...
	private DeviceListener mListener = new AbstractDeviceListener() {
		...
		public void onPose(Myo myo, long timestamp, Pose pose) {
			...
			//poseDependingOnState(myo, mAppState, pose);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		Notification noti = new Notification.Builder(this).setContentTitle("Myo Bridge")
				.setContentText("Running Myo Bridge").setSmallIcon(R.drawable.myo_icon).build();
	...
	/*
	public void poseDependingOnState(Myo myo, appState currentState, Pose pose){
